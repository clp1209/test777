...
SYMBOL_CRC(i2c_device_func_read, 0x7751408f, "");
SYMBOL_CRC(i2c_device_func_write, 0x2a9ad4c3, "");
...
MODULE_ALIAS("of:N*T*Cwb-i2c-dev");
MODULE_ALIAS("of:N*T*Cwb-i2c-devC*");
MODULE_ALIAS("i2c:wb-i2c-dev");

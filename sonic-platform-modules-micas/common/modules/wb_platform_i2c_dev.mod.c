...
SYMBOL_CRC(platform_i2c_device_func_read, 0x9a2b799c, "");
SYMBOL_CRC(platform_i2c_device_func_write, 0xaec9ef24, "");
...
MODULE_ALIAS("of:N*T*Cwb-platform-i2c-dev");
MODULE_ALIAS("of:N*T*Cwb-platform-i2c-devC*");
